<div class=" w-full max-w-screen h-screen max-h-full flex flex-col gap-5">
    <div class="grid md:grid-cols-3 place-items-center lg:px-16 pt-7 gap-5 ">
        <div class="md:hidden">
            <a href="{{route('home')}}">
                <h2 class="text-black font-Oswald font-light md:text-[80px] text-[40px] text-center">BEAUTY SPA</h2>
            </a>
        </div>
        <div>
            <p class="text-black font-Julius font-[24px] text-center">LLAMANOS</p>
            <p class="text-black font-Julius font-[24px]">+52 775 162 1020</p>
        </div>
        <div>
            <a href="{{route('home')}}">
                <h2 class="hidden md:block text-black font-Oswald font-light text-[80px] text-center">BEAUTY SPA</h2>
            </a>
        </div>
        ...
        <nav class="">
            <div class="flex flex-wrap items-center justify-between mx-auto p-4">
                <button data-collapse-toggle="navbar-user" type="button"
                    class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-black rounded-lg md:hidden hover:bg-black hover:text-white transition-all duration-200"
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-user">
                    <ul
                        ...
                        <li>
                            <a href="{{route('home')}}"
                                class="block py-2 px-3 font-Junge text-black  rounded hover:text-black md:bg-transparent md:p-0 md:hover:text-spa-400 md:hover:text-lg transition-all duration-200"
                                aria-current="page">Home</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 px-3 font-Junge text-black  rounded hover:bg-gray-100 hover:text-black md:hover:bg-transparent md:p-0 md:hover:text-spa-400 md:hover:text-lg transition-all duration-200">Videos</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 px-3 font-Junge text-black  rounded hover:bg-gray-100 hover:text-black md:hover:bg-transparent md:p-0 md:hover:text-spa-400 md:hover:text-lg transition-all duration-200">Galeria</a>
                        </li>
                        <li>
                            <a href="{{route('section_services')}}"
                                class="block py-2 px-3 font-Junge text-black  rounded hover:bg-gray-100 hover:text-black md:hover:bg-transparent md:p-0 md:hover:text-spa-400 md:hover:text-lg transition-all duration-200">Servicios</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 px-3 font-Junge text-black  rounded hover:bg-gray-100 hover:text-black md:hover:bg-transparent md:p-0 md:hover:text-spa-400 md:hover:text-lg transition-all duration-200">Productos</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 px-3 font-Junge text-black  rounded hover:bg-gray-100 hover:text-black md:hover:bg-transparent md:p-0 md:hover:text-spa-400 md:hover:text-lg transition-all duration-200">Nosotros</a>
                        </li>
                    </ul>
                </div>
                ...
                @if (!Auth::user())
                    ...
                    <a href="{{route('login')}}"
                        class="block py-2 px-3 text-spa-400 rounde hover:bg-transparent md:border-0 hover:font-bold md:p-0 hover:text-spa-700 hover:text-lg transition-all duration-200">Login</a>
                        ...
                        @if (Auth::user()->roles_id == 2)
                            <li>
                                <button type="button" class="flex text-sm md:me-0" id="user-menu-button"
                                    ...
                                    <svg class="w-10 h-10 text-black" aria-hidden="true"
                        ...
                        <ul class="py-2" aria-labelledby="user-menu-button">
                            <li>
                                <a href="{{route('my_profile')}}"
                                    class="block px-4 py-2 text-sm text-black hover:bg-black hover:text-white">Ir a mi Perfil</a>
                            </li>
                            @if (Auth::user()->roles_id == 2)
                            <li>
                                <a href="#"
            ...
            <div class="md:flex md:justify-between lg:px-[100px] md:px-[20px] w-full">
                <div class="mb-6 md:mb-0">
                    <a href="/" class="flex items-center justify-center lg:justify-normal">
                        <img src="images\logo.png" class="lg:max-w-[400px] md:max-w-[200px] max-w-[100px" alt="" />
                    </a>
                </div>
